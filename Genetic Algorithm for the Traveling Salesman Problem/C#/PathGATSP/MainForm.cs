...
namespace PathGATSP
{
    public partial class MainForm : Form
    {
        ...
        {
            //컨테이너 적재 패턴
            CLPLib.CLP clp = new CLPLib.CLP();
            List<CLPLib.LoadedBox> list = clp.solveCLP(ga.MinTour);
            CLPLib.Size final_CG = clp.CG;
            double final_Weight = clp.LoadedWeight;
                        
            CLPLib.ContainerViewer cv = new CLPLib.ContainerViewer();
            cv.ListBoxLoaded = list;
            cv.Show();
